...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/Tools/curl/curl-android-$(TARGET_ARCH_ABI)/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/Tools/curl/openssl-android-$(TARGET_ARCH_ABI)/include
